            ...
            <CreditsStyled>
                <div>
                    ...
                    <p>
                        <a
                            ...
                            href="https://fr.linkedin.com/in/stephanelucon"
                            target="_blank"
                ...
                <div>
                    ...
                    <p>
                        <a
                            className="credits-link"
                            href="https://fr.linkedin.com/in/nicolas-tchouanmou-7029a112"
                            target="_blank"
                            rel="noopener noreferrer">
                            Nicolas Tchouanmou
                        </a>
                    ...
                    <p>
                        <a
                            className="credits-link"
                            href="http://twitter.com/hugogresse"
                            target="_blank"
                            rel="noopener noreferrer">
                            Hugo Gresse
                        </a>
                ...
                <div>
                    ...
                    <p>
                        <a
                            className="credits-link"
                            href="https://fr.linkedin.com/in/sebastienlhoste"
                            target="_blank"
                            rel="noopener noreferrer">
                            Sébastien L'Hoste
                        </a>
                    ...
                    <p>
                        <a
                            className="credits-link"
                            href="https://fr.linkedin.com/in/antoinedeglesne"
                            target="_blank"
                            rel="noopener noreferrer">
                            Antoine Deglesne
                        </a>
                ...
                <div>
                    ...
                    <p>
                        <a
                            className="credits-link"
                            href="https://fr.linkedin.com/in/oph%C3%A9lie-strezlec-b40385103"
                            target="_blank"
                            rel="noopener noreferrer">
                            Ophélie Strezlec
                        </a>
