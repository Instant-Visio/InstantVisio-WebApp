    ...
    <>
        ...
        <LegalMentionsStyled>
            <Container className="legal-mentions">
                <h2 className="legal-mentions-title">Informations légales</h2>
                <h3 className="legal-mentions-title-smallTitle">1. Présentation du site</h3>
                ...
                Crédits : <a href="https://abebangwe.com" target="_blank" rel="noopener noreferrer">Abeba Ngwe</a>,&nbsp; 
                <a href="https://fr.linkedin.com/in/nicolas-tchouanmou-7029a112" target="_blank" rel="noopener noreferrer">Nicolas Tchouanmou</a>,&nbsp; 
                <a href="https://fr.linkedin.com/in/hugogresse" target="_blank" rel="noopener noreferrer">Hugo Gresse</a>,&nbsp;
                ...
                <h3 className="legal-mentions-title-smallTitle">2. Conditions générales d’utilisation du site et des services proposés</h3>
                ...
                <h3 className="legal-mentions-title-smallTitle">3. Description des services fournis</h3>
                ...
                <h3 className="legal-mentions-title-smallTitle">4. Limitations contractuelles sur les données techniques</h3>
                <p>Le site utilise la technologie JavaScript.</p>
                <p>Le site Internet ne pourra être tenu responsable de dommages matériels liés à l’utilisation du site. De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel récent, ne contenant pas de virus et avec un navigateur de dernière génération mis à jour.</p>
                
                <h3 className="legal-mentions-title-smallTitle">5. Propriété intellectuelle et contrefaçons</h3>
                ...
                <h3 className="legal-mentions-title-smallTitle">6. Limitations de responsAbeba Ngwelité</h3>
                ...
                <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des utilisateurs. Stéphane Luçon se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions relatives à la protection des données. Le cas échéant, Stéphane Luçon se réserve également la possibilité de mettre en cause la responsAbeba Ngwelité civile et/ou pénale de l’utilisateur, notamment en cas de message à caractère raciste, injurieux, diffamant, ou pornographique, quel que soit le support utilisé (texte, photographie…).</p>
                
                <h3 className="legal-mentions-title-smallTitle">7. Gestion des données personnelles</h3>
                <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août 2004, l'article L. 226-13 du Code pénal et la Directive Européenne du 24 octobre 1995.</p>
                <p>A l'occasion de l'utilisation du site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a>, peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a>, le fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>
                <p> En tout état de cause Stéphane Luçon ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains services proposés par le site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a>. L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a> l’obligation ou non de fournir ces informations.</p>
                <p>Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification et d’opposition aux données personnelles le concernant, en effectuant sa demande écrite et signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.</p>
                <p>Aucune information personnelle de l'utilisateur du site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a> n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de Stéphane Luçon et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a>.</p>
                <p>Le site n'est pas déclaré à la CNIL car il ne recueille pas d'informations personnelles. .</p>
                <p>Les bases de données sont protégées par les dispositions de la loi du 1er juillet 1998 transposant la directive 96/9 du 11 mars 1996 relative à la protection juridique des bases de données.</p>
                
                <h3 className="legal-mentions-title-smallTitle">8. Liens hypertextes et cookies</h3>
                <p>Le site <a href="http://https://instantvisio.com/" target="_blank" rel="noopener noreferrer">https://instantvisio.com</a> contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de Stéphane Luçon. Cependant, Stéphane Luçon n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsAbeba Ngwelité de ce fait.</p>
                ...
                <h3 className="legal-mentions-title-smallTitle">9. Droit applicable et attribution de juridiction</h3>
                ...
                <h3 className="legal-mentions-title-smallTitle">10. Les principales lois concernées</h3>
                <p>Loi n° 78-17 du 6 janvier 1978, notamment modifiée par la loi n° 2004-801 du 6 août 2004 relative à l'informatique, aux fichiers et aux libertés.</p>
                <p> Loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique.</p>
                
                <h3 className="legal-mentions-title-smallTitle">11. Lexique</h3>
