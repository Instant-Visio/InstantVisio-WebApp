    ...
    <>
        ...
        <DefaultStyled>
            <Container className="default">
                ...
                <h3 className="default-smallTitle">6. Limitations de responsAbeba Ngwelité</h3>
                ...
                <h3 className="default-smallTitle">7. Gestion des données personnelles</h3>
                ...
                <h3 className="default-smallTitle">8. Liens hypertextes et cookies</h3>
                ...
                <h3 className="default-smallTitle">9. Droit applicable et attribution de juridiction</h3>
                ...
                <h3 className="default-smallTitle">10. Les principales lois concernées</h3>
                <p>Loi n° 78-17 du 6 janvier 1978, notamment modifiée par la loi n° 2004-801 du 6 août 2004 relative à l'informatique, aux fichiers et aux libertés.</p>
                <p> Loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique.</p>
                
                <h3 className="default-smallTitle">11. Lexique</h3>
